...
const HeaderNav = () => {
	...
	return (
		<>
			...
			<div className={`fixed md:static top-0 right-0 pt-14 md:pt-0 w-60 md:w-auto h-screen md:h-auto transition-transform bg-white ${isWide? "hidden md:block" : `block ${isOpen ? "" : "translate-x-[16rem]"}`}`}>
